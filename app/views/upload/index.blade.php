...
<div class="panel text-center col-xs-4 col-sm-4" >
    ...
    <div id="options" class="row">
        ...
        {{--testing emails--}}
        <button type="button" class="btn btn-lg btn-default btn-primary" onclick="window.location='{{ url("email/sharetransfer/5") }}'"><i class="glyphicon glyphicon-envelope"></i> Share</button>
    </div>
</div>
